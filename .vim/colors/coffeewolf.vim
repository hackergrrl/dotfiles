...
" Control flow stuff is tardis.
call s:HL('Statement',   'darkroast', '', 'bold')
call s:HL('Keyword',     'darkroast', '', 'bold')
call s:HL('Conditional', 'darkroast', '', 'bold')
call s:HL('Operator',    'darkroast', '', 'none')
call s:HL('Label',       'darkroast', '', 'none')
call s:HL('Repeat',      'darkroast', '', 'none')

" Functions and variable declarations are orange, because plain looks weird.
call s:HL('Identifier', 'coffee', '', 'none')
call s:HL('Function',   'coffee', '', 'none')
